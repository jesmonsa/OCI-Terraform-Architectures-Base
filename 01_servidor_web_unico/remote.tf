...
resource "null_resource" "EnterpriseWebserver1HTTPD" {
  depends_on = [oci_core_instance.EnterpriseWebserver1]
  triggers = {
  ...
  provisioner "remote-exec" {
    connection {
      type        = "ssh"
      user        = "opc"
      host        = data.oci_core_vnic.EnterpriseWebserver1_VNIC1.public_ip_address
    ...
    inline = [
      ...
      "sudo /bin/su -c \"echo 'Welcome to Enterprise Infrastructure! This is WEBSERVER1...' > /var/www/html/index.html\"",
