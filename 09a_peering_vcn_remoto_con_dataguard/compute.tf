...
resource "oci_core_instance" "EnterpriseWebserver" {
  ...
  create_vnic_details {
    ...
    nsg_ids          = [oci_core_network_security_group.EnterpriseWebSecurityGroup.id]
  }
}
...
resource "oci_core_instance" "EnterpriseBastionServer" {
  ...
  create_vnic_details {
    ...
    nsg_ids          = [oci_core_network_security_group.EnterpriseSSHSecurityGroup.id]
  }
}
...
resource "oci_core_instance" "EnterpriseBackendserver1" {
  ...
  create_vnic_details {
    ...
    assign_public_ip = false
    nsg_ids          = [oci_core_network_security_group.EnterpriseSSHSecurityGroup2.id]
  }
}
