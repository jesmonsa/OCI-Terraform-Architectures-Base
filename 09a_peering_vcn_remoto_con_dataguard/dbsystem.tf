...
resource "oci_database_data_guard_association" "EnterpriseDBSystemStandby" {
  ...
  database_id                      = oci_database_db_system.EnterpriseDBSystem.db_home[0].database[0].id
  ...
  nsg_ids             = [oci_core_network_security_group.EnterpriseDBSystemSecurityGroup2.id]
