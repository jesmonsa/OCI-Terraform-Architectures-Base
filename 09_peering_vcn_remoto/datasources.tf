...
data "oci_core_vnic_attachments" "EnterpriseBackendserver1_VNIC1_attach" {
  provider            = oci.region2
  ...
  instance_id         = oci_core_instance.EnterpriseBackendserver1.id
}

# BackendServer Compute VNIC DataSource
data "oci_core_vnic" "EnterpriseBackendserver1_VNIC1" {
  provider = oci.region2
  vnic_id  = data.oci_core_vnic_attachments.EnterpriseBackendserver1_VNIC1_attach.vnic_attachments.0.vnic_id
}
