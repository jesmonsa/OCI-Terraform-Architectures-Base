...
```bash
git clone https://github.com/mlinxfeld/enterprise_tf_oci_course.git
cd enterprise_tf_oci_course/
...
1. Click [![Deploy to Oracle Cloud](https://oci-resourcemanager-plugin.plugins.oci.oraclecloud.com/latest/deploy-to-oracle-cloud.svg)](https://cloud.oracle.com/resourcemanager/stacks/create?region=home&zipUrl=https://github.com/mlinxfeld/enterprise_tf_oci_course/releases/latest/download/LESSON9_vcn_remote_peering.zip)
...
## Contributing
This project is open source. Please submit your contributions by forking this repository and submitting a pull request! [Enterprise.com](https://enterprise.com/) appreciates any contributions that are made by the open source community.

## License
Copyright (c) 2025 [Enterprise.com](https://enterprise.com/)
