...
variable "region1" {
  description = "The first region where OCI resources will be deployed, such as 'us-ashburn-1' or 'us-phoenix-1'."
  default = "us-ashburn-1"
}

variable "region2" {
  description = "The second region where OCI resources will be deployed, such as 'us-phoenix-1' or 'us-sanjose-1'."
...
variable "DBNodeDomainName" {
  ...
  default     = "EnterpriseN4.EnterpriseVCN.oraclevcn.com"
}
