...
<details>
<summary>📁 <strong>Error de File Storage</strong></summary>

**Problema**: `Error: Cannot mount file system`

**Solución**:
1. Verifica que el File Storage esté creado: `terraform state list | grep file`
2. Comprueba la conectividad de red: `ping [IP_MOUNT_TARGET]`
3. Verifica los permisos de montaje: `showmount -e [IP_MOUNT_TARGET]`
4. Revisa los logs de Ansible para errores de montaje
