...
# Database NSG
resource "oci_core_network_security_group" "EnterpriseDBSecurityGroup" {
  compartment_id = oci_identity_compartment.EnterpriseCompartment.id
  display_name   = "EnterpriseDBSecurityGroup"
  vcn_id         = oci_core_virtual_network.EnterpriseVCN.id
...
# Database NSG Egress Rules - DNS/NTP only
resource "oci_core_network_security_group_security_rule" "EnterpriseDBSecurityEgressDNSGroupRule" {
  network_security_group_id = oci_core_network_security_group.EnterpriseDBSecurityGroup.id
  direction                 = "EGRESS"
  protocol                  = "17"  # UDP
  destination               = "0.0.0.0/0"
  destination_type          = "CIDR_BLOCK"
...
# Database NSG Egress Rules - NTP
resource "oci_core_network_security_group_security_rule" "EnterpriseDBSecurityEgressNTPGroupRule" {
  network_security_group_id = oci_core_network_security_group.EnterpriseDBSecurityGroup.id
  direction                 = "EGRESS"
  protocol                  = "17"  # UDP
  destination               = "0.0.0.0/0"
...
# Database NSG Ingress Rules for Oracle Database port 1521 - SOLO desde Web NSG
resource "oci_core_network_security_group_security_rule" "EnterpriseDBSecurityIngressOracleGroupRule" {
  network_security_group_id = oci_core_network_security_group.EnterpriseDBSecurityGroup.id
  direction                 = "INGRESS"
  protocol                  = "6"
  source                    = oci_core_network_security_group.EnterpriseWebserverSecurityGroup.id
...
# Database NSG Ingress Rules for SSH from Bastion
resource "oci_core_network_security_group_security_rule" "EnterpriseDBSecurityIngressSSHGroupRule" {
  network_security_group_id = oci_core_network_security_group.EnterpriseDBSecurityGroup.id
  direction                 = "INGRESS"
  protocol                  = "6"
